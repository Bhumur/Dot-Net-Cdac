...
using EFCCodeFirstWithAnnotation.Models;

namespace EFCCodeFirstWithAnnotation.Controllers
{
    public class EmployeesController : Controller
    {
        private readonly EmpAnnotationContext _context;

        public EmployeesController(EmpAnnotationContext context)
        {
            _context = context;
        }
        ...
        {
            var empAnnotationContext = _context.Employees.Include(e => e.DeptNoNavigation);
            return View(await empAnnotationContext.ToListAsync());
        }
